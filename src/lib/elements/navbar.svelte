...
<div id="pastille">
  {#if nav.logged}
      <span class="material-symbols-outlined icon" on:click={change_text}>{text}</span>
      <a class="material-symbols-outlined icon" href="/explore">home</a>
      <a class="material-symbols-outlined icon" href="/search">search</a>
      <a class="material-symbols-outlined icon" href="/notifications">notifications</a>
      <a class="material-symbols-outlined icon" href="/settings">settings</a>
      <img
  ...
  {:else}
      ...
      <a class="trans-button" id="explore" href="/more">More</a>
  {/if}
</div>
...
<style>
        ...
        .icon {font-size: var(--text-size-4)}
        }
