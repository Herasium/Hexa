...
<div id="post" class="post">
    ...
    <div id="post-stats" class="text">
      {post["data"]["likes"]} <span class="small">Likes</span> {post["data"]["comments_number"]} <span class="small"> Comments</span>
    </div>
    <div id="post-icons" class="stats text">
        <span
