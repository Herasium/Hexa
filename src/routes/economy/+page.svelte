...
<div id="cont-3" class="container">
    ...
    <div id="send-container">
      ...
      <p style="text-align: left; display: inline-block; margin: 0;font-size: 40px;" class="material-symbols-outlined">person</p>
      <input class="real-input text" bind:value={user} />
    </div>

      <div class="input text" style="margin-bottom: 20%;">
        <img class="a-blockcoin" src={bc} alt="A white version of the blockcoin logo." />
        <input type="number" class="real-input text" style="width: calc(30% - 20px);" bind:value={amount} />
      </div>
        <div class="button" on:click={send}><p>Send</p>
      </div>
    </div>
</div>
