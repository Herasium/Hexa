<script>
	...
	const placeholder_list = [
		...
		"🎉 BlockCoin is open source, we will be glad if you would like to contribute.",
		"You are legally obligated to subscribe to BlockCoin Premium.",
...
<div class="bg">
	...
	<div class="under">
		...
		<form method="post" action="/post/comment">
			<textarea name="comment" value={value} readonly style="display:none"></textarea>
            <input name="replying" value={replying} readonly style="display:none" />
            <input name="replier" value={replier} readonly style="display:none" />
			<button class="post" type="submit">{!replying ? "Comment" : "Reply"}!</button>
		</form>
	</div>
</div>
